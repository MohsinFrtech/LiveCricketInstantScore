...
import com.ruthal.live.cricket.app.utils.CodeUtils.convertDateAndTime
...
class RecentMatchesAdapter(
    ...
    val source: String,
    private val list: List<ScoresModel?>,
    private val adType: String,
    private val adManager: AdManager,
) :
    ListAdapter<ScoresModel, RecyclerView.ViewHolder>(
    ...
    class LiveSliderAdapterViewHolder(
        ...
        fun bindMatchesData(liveScoresModel: ScoresModel, source: String) {
        ...
        return when (viewType) {
            nativeAdsLayout -> {
                ...
                val binding: MatchItemBinding = DataBindingUtil.inflate(
                    LayoutInflater.from(context), R.layout.match_item, parent, false
                )
